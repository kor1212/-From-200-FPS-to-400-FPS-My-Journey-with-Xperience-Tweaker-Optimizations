...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDpQQQ2MNXiuFLQI5/rHy++UqVkSRN4HaIrJ07GAI+VT3lLhdJ0oxDRfgM5s
::YB416Ek+ZW8=
::
::
::978f952a14a936cc963da21a135fa983
@echo off
@title Xperience Tweaker
...
echo.
echo                                ▄▄▄▄▄▄                                     ##############################
echo                               ████████                                           %COL%[92mXperience Tweaker%COL%[33m
echo                               ████████                                          %COL%[92mby Cipher%COL%[33m
echo                  ▄███▄       ▄████████▄       ▄███▄                       ##############################
echo                ▄███████▄▄▄████████████████▄▄▄███████▄   
...
powershell Checkpoint-Computer -Description 'Xperience Restore Point' >nul 2>&1
...
PowerShell Invoke-WebRequest "https://raw.githubusercontent.com/Teramanbr/XperienceTweaker/main/src/Regedit.reg" -OutFile "%temp%\Regedit.reg" >nul 2>&1
...
powershell Invoke-WebRequest "https://github.com/Teramanbr/XperienceTweaker/blob/main/src/PowerPlan.pow?raw=true" -OutFile "C:\TT\PowerPlan.pow"
cls
...
powercfg /changename 44444444-4444-4444-4444-444444444449 "HoneCtrl's Power Plan" "The Ultimate Power Plan to increase FPS, improve latency and reduce input lag. (Added by Xperience Tweaker)" >nul 2>&1 
...
powershell Invoke-WebRequest "https://github.com/Teramanbr/XperienceTweaker/blob/main/src/CPUTweaks.ps1?raw=true" -OutFile "C:\TT\CPUTweaks.ps1"
...
PowerShell Invoke-WebRequest "https://raw.githubusercontent.com/Teramanbr/XperienceTweaker/main/src/VALORANT.ps1" -OutFile "C:\TT\VALORANT.ps1" >nul 2>&1
...
powershell.exe Invoke-WebRequest "https://raw.githubusercontent.com/Teramanbr/XperienceTweaker/main/src/SteamInit.ps1" -OutFile "C:\TT\SteamInit.ps1" >nul 2>&1
...
:EndEN
powershell Invoke-WebRequest "https://raw.githubusercontent.com/Teramanbr/XperienceTweaker/main/src/thanksforusing.bat" -OutFile "C:\TT\thanksforusing.bat"
...
PowerShell Invoke-WebRequest "https://raw.githubusercontent.com/Teramanbr/XperienceTweaker/main/src/shutdown.ps1" -OutFile "C:\TT\shutdown.ps1" >nul 2>&1
